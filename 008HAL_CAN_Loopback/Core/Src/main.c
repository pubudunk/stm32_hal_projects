...
void CAN1_TX(void)
{
	...
	while( HAL_CAN_IsTxMessagePending( &hcan1, ulTxMailBox) );

	Log_Message("Message Transmitted\n");
}
...
void CAN1_RX(void)
{
	...
	/* Wait until atleast one message is in the FIFO */
