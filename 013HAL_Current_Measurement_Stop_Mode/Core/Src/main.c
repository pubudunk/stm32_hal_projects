...
char uart_data[] = "Program to test STOP mode power\r\n";
static unsigned char ucUserButtonStatus = RESET;
...
int main(void)
{
	...
	Log_Message("Wait for user push button\r\n");
...
//#define STOPMODE_MRON_FLASHON
//#define STOPMODE_MRON_FLASHDOWN
//#define STOPMODE_LPRON_FLASHON
//#define STOPMODE_LPRON_FLASHDOWN
//#define STOPMODE_MRUNDRV_FLASHDOWN
#define STOPMODE_LPRUNDRV_FLASHDOWN
...
#ifdef STOPMODE_MRON_FLASHON
	PWR_StopMainRegFlashOn();
#endif

#ifdef STOPMODE_MRON_FLASHDOWN
	PWR_StopMainRegFlashPwrDn();
#endif

#ifdef STOPMODE_LPRON_FLASHON
	PWR_StopLPRegFlashOn();
#endif

#ifdef STOPMODE_LPRON_FLASHDOWN
	PWR_StopLPRegFlashPwrDn();
#endif

#ifdef STOPMODE_MRUNDRV_FLASHDOWN
	PWR_StopMainRegUnderDrvFlashPwrDn();
#endif

#ifdef STOPMODE_LPRUNDRV_FLASHDOWN
	PWR_StopLPRRegUnderDrvFlashPwrDn();
#endif

	ucUserButtonStatus = RESET;
}
...
void WaitUser_PushBotton(void)
{
	...
	while(ucUserButtonStatus != SET); //wait here
...
void GPIO_Init(void)
{
	...
	/* User button config for interrupt input */
...
{
	Log_Message("User button pressed\r\n");
	ucUserButtonStatus = SET;
}
